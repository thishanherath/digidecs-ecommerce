...
export default function Register() {
  ...
  const { openLoginModal, closeAuthModal } = useContext(ModalContext);
    ...
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-gray-500 mt-2 text-sm font-medium">
          Join Digidecs to explore premium tech
        </p>
      </div>
      ...
      <form className="space-y-4" onSubmit={handleRegister}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400 group-focus-within:text-primary-purple transition-colors">
              <User size={16} strokeWidth={2} />
            </div>
            <input
              type="text"
              placeholder="First Name"
              className="w-full pl-10 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-text-dark font-medium placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-purple/20 focus:border-primary-purple transition-all duration-300"
              value={firstName}
