...
export default function Navbar() {
  ...
  return (
    <nav className="flex flex-col font-sans">
      {/* Tier 1: Top Bar */}
      <div className="bg-gray-100 text-[11px] py-1.5 text-text-dark/70 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="font-semibold tracking-widest uppercase">THE REVOLUTIONARY MOBILE STORE</div>
          <div className="flex items-center gap-6 font-semibold uppercase tracking-wider">
            <Link to="/store-locator" className="hover:text-text-dark transition-colors">Store Locator</Link>
            {user ? (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-20 items-center">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden lg:flex items-center gap-3">
              <Phone className="text-text-dark" size={28} strokeWidth={1.5} />
              <div className="flex flex-col">
                <span className="text-text-dark/60 text-[10px] font-bold uppercase tracking-wider">Hotline</span>
                <span className="font-extrabold text-text-dark text-base tracking-tight">+94 777 19 19 19</span>
              </div>
            </div>
            ...
            <Link to="/cart" className="relative flex flex-col items-center justify-center group text-text-dark hover:text-primary-purple transition-colors">
              ...
              <span className="text-[10px] font-bold mt-1 uppercase tracking-wider">Cart</span>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-14 items-center gap-6">
          ...
          <div className="flex items-center h-full border-x border-gray-200 px-6 min-w-[240px] cursor-pointer group relative">
            <Menu size={18} className="text-text-dark mr-3" strokeWidth={1.5} />
            <span className="font-bold text-text-dark text-sm">Browse By Brand</span>
            <ChevronDown size={14} className="text-gray-400 ml-auto" strokeWidth={2} />
